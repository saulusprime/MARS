...
_CORNICE_EN: Dict[str, str] = {
    ...
    # Le intestazioni di tabella e il piede del referto (U11).
    "Profilo": "Profile",
    # Terza colonna delle due tabelle con la barra: la barra e' il
    # numero della colonna accanto ridisegnato, e l'intestazione lo
    # dice invece di restare vuota.
    "Proporzione": "Proportion",
    "audit di citabilità per assistenti IA":
        "citability audit for AI assistants",
    "Generato da mars_audit.py v%s · fusione RRF con k=%s":
        "Generated by mars_audit.py v%s · RRF fusion with k=%s",
    "Fonti del metodo:": "Sources of the method:",
