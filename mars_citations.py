...
# Citazioni
# --------------------------------------------------------------------
# norm_host() e host_matches() vivono in mars_core.py: servono
# identiche al filtro same-host del crawler.
        ...
        try:
            for _ in range(PAUSE_TURN_RESTARTS):
                ...
                if resp.stop_reason == "pause_turn":
                    # Accodare, non ricostruire: sostituire il turno
                    # perderebbe le ricerche gia' fatte dalla seconda
                    # pausa in poi, e il modello le rifarebbe.
                    messages = messages + [{
