...
- `flake8` e `pytest` **non sono nel PATH**: si invocano da `.venv/bin/`.
  Riferimento al 2026-08-28: `flake8` 0, `pytest` **1292 passed**.
...
**I8**, **I4+I9**, **I15** e **I18** sono chiuse il 2026-08-28 e stanno in [AS-IS.md](AS-IS.md); `__version__` è a
**2.17.0**. Del programma UPGRADE resta la sola **U12**, che il piano dichiara
opzionale e che non ha una casella finché non si decide di farla. I2, I8, I4+I9 e I15 erano
idee, non caselle, e I18 e' nata gia' decisa: l'hanno avuta quando sono state decise, ed è il precedente
...
**E una sul catalogo dei fix**: da I18 `mars_fixes.vesti()` veste i soli
rilievi che dichiarano una `penalty` nei params — un controllo superato non
si corregge — quindi un modulo nuovo che non la dichiari non vedra' mai il
proprio testo di catalogo.
